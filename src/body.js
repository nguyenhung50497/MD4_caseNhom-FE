                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav ms-lg-auto">
                            <li class="nav-item ms-2">
                                <a class="active btn custom-btn custom-border-btn smoothscroll">Home</a>
                            </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-12">
                            <div class="text-center mb-5 pb-2">
                                <h1 class="text-white">Listen to Music</h1>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-lg-auto">
                        ...
                        <li class="nav-item dropdown ms-2">
                            <a class="nav-link dropdown-toggle btn custom-btn custom-border-btn smoothscroll" style="height: 45px;" id="navbarLightDropdownMenuLink" role="button"
                                data-bs-toggle="dropdown" aria-expanded="false">Pages</a>
                            ...
                            <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="navbarLightDropdownMenuLink">
                                ...
                                <li><a class="dropdown-item" >Detail Page</a></li>
                            </ul>
                        </li>
                    </ul>
